class SalaryValueSerializer < ActiveModel::Serializer
  ...
  def decimal_value
    ...
    return (result.round(4) rescue result) if object.salary_column_id == 73
    return (result.round(2) rescue result) if round_two.include? object.salary_column_id
    return (result.round rescue result)
  end
